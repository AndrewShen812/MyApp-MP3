...
import com.na517.lf.utils.HttpDownloadUtils;
import com.na517.lf.utils.download.DownloadReport;
...
//                Log.i("LF", "audio count=" + audios.size());
                ...
                mAudioUtils.playAudioOnline(mSong.songLink);
//                mAudioUtils.playLocalAudio(audios.get(audios.size()-1).getPath());
                break;
